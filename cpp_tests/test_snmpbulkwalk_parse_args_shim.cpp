...
class SnmpBulkWalkParseArgsShimTest : public ::testing::Test {};

TEST_F(SnmpBulkWalkParseArgsShimTest, TestParseArgsErrorThrowsParseError) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpbulkwalk(args, "testing_bulkwalk_parse_args_error");
...
TEST_F(SnmpBulkWalkParseArgsShimTest, TestParseArgsSuccessExitThrowsParseError) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpbulkwalk(args, "testing_bulkwalk_parse_args_success_exit");
          } catch (ParseErrorBase const &e) {
             std::string msg(e.what());
