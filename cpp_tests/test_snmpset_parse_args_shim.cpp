...
class SnmpSetParseArgsShimTest : public ::testing::Test {};

TEST_F(SnmpSetParseArgsShimTest, TestParseArgsErrorThrowsParseError) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpset(args, "testing_set_parse_args_error");
...
TEST_F(SnmpSetParseArgsShimTest, TestParseArgsSuccessExitThrowsParseError) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpset(args, "testing_set_parse_args_success_exit");
          } catch (ParseErrorBase const &e) {
             std::string msg(e.what());
