...
class SnmpBulkGetShimTest : public ::testing::Test {
  protected:
   void SetUp() override {}
   void TearDown() override {}
};

TEST_F(SnmpBulkGetShimTest, TestPacketErrorFromShim) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpbulkget(args, "testing_bulkget_shim");
...
TEST_F(SnmpBulkGetShimTest, TestPacketErrorWithoutErrindexDoesNotThrow) {
   ...
   EXPECT_NO_THROW({
      auto results = snmpbulkget(args, "testing_bulkget_shim_errindex_zero");
