...
class SnmpBulkGetParseArgsShimTest : public ::testing::Test {};

TEST_F(SnmpBulkGetParseArgsShimTest, TestParseArgsErrorThrowsParseError) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpbulkget(args, "testing_bulkget_parse_args_error");
...
TEST_F(SnmpBulkGetParseArgsShimTest, TestParseArgsSuccessExitThrowsParseError) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpbulkget(args, "testing_bulkget_parse_args_success_exit");
          } catch (ParseErrorBase const &e) {
             std::string msg(e.what());
