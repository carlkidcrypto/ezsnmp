...
class SnmpBulkWalkShimTest : public ::testing::Test {
  protected:
   void SetUp() override {}
   void TearDown() override {}
};

TEST_F(SnmpBulkWalkShimTest, TestPacketErrorFromShim) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpbulkwalk(args, "testing_bulkwalk_shim");
...
TEST_F(SnmpBulkWalkShimTest, TestPacketErrorWithoutErrindexDoesNotThrow) {
   ...
   EXPECT_NO_THROW({
      auto results = snmpbulkwalk(args, "testing_bulkwalk_shim_errindex_zero");
