...
class SnmpGetNextParseArgsShimTest : public ::testing::Test {};

TEST_F(SnmpGetNextParseArgsShimTest, TestParseArgsErrorThrowsParseError) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpgetnext(args, "testing_getnext_parse_args_error");
...
TEST_F(SnmpGetNextParseArgsShimTest, TestParseArgsSuccessExitThrowsParseError) {
   ...
   EXPECT_THROW(
       {
          try {
             auto results = snmpgetnext(args, "testing_getnext_parse_args_success_exit");
          } catch (ParseErrorBase const &e) {
             std::string msg(e.what());
