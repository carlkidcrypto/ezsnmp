...
diff -Naurw ~/Downloads/net-snmp-master/apps/snmpget.c ../src/snmpget.cpp > snmpget.patch
diff -Naurw ~/Downloads/net-snmp-master/apps/snmpset.c ../src/snmpset.cpp > snmpset.patch
