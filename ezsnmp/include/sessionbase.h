...
class SessionBase {
  ...
  public:
    ...
    */
   std::vector<ResultBase> walk(std::string const& mib = "");
    ...
    * @return A vector of ResultBase objects containing the retrieved data.
    */
   std::vector<ResultBase> bulk_walk(std::string const& mib);
    ...
    * @return A vector of ResultBase objects containing the retrieved data.
    */
   std::vector<ResultBase> bulk_walk(std::vector<std::string> const& mibs);
    ...
    * @return A vector of ResultBase objects containing the retrieved data.
    */
   std::vector<ResultBase> get(std::string const& mib = "");
    ...
    * @return A vector of ResultBase objects containing the retrieved data.
    */
   std::vector<ResultBase> get(std::vector<std::string> const& mibs);
    ...
    * @return A vector of ResultBase objects containing the retrieved data.
    */
   std::vector<ResultBase> get_next(std::vector<std::string> const& mibs);
    ...
    * @return A vector of ResultBase objects containing the retrieved data.
    */
   std::vector<ResultBase> bulk_get(std::vector<std::string> const& mibs);
    ...
    */
   std::vector<ResultBase> set(std::vector<std::string> const& mibs);
