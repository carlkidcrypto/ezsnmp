class GenericError(Exception):
    """Exception raised for general SNMP errors in the ezsnmp library.
...
class NoSuchInstanceError(GenericError):
    """Exception raised when an SNMP operation encounters a "No Such Instance" error.
...
class NoSuchNameError(GenericError):
    """Exception raised when an SNMP operation encounters a "No Such Name" error.
...
class NoSuchObjectError(GenericError):
    """Exception raised when an SNMP operation encounters a "No Such Object" error.
...
class PacketError(GenericError):
    """Exception raised when an error occurs related to SNMP packet processing.
...
class ParseError(GenericError):
    """Exception raised when an error occurs while parsing SNMP messages or arguments.
...
class UndeterminedTypeError(GenericError):
    """Exception raised when an SNMP type cannot be determined.
...
class UnknownObjectIDError(GenericError):
    """Exception raised when an unknown SNMP Object ID is encountered.
