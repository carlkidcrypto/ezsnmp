...
class Session(SessionBase):
    ...
    def security_username(self):
        ...
        return self.get_security_username()

    @property
    def privacy_protocol(self):
        """Get the privacy protocol."""
        return self.get_privacy_protocol()

    @property
    def privacy_passphrase(self):
        """Get the privacy passphrase."""
        return self.get_privacy_passphrase()

    @property
    def boots_time(self):
        """Get the boots time."""
        return self.get_boots_time()
