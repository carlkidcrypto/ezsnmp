...
static PyMethodDef SwigMethods[] = {
	 { "snmpbulkget", _wrap_snmpbulkget, METH_O, "snmpbulkget(args) -> std::vector< std::string,std::allocator< std::string > >"},
	 { "snmpbulkwalk", _wrap_snmpbulkwalk, METH_O, "snmpbulkwalk(args) -> std::vector< std::string,std::allocator< std::string > >"},
	 { "snmpget", _wrap_snmpget, METH_O, "snmpget(args) -> std::vector< std::string,std::allocator< std::string > >"},
