...
static PyTypeObject *SwigPyBuiltin__swig__SwigPyIterator_type_create(PyTypeObject *type,
   ...
   PyType_Slot slots[] = {
       ...
       {0, NULL}};
   PyType_Spec spec = {"netsnmp.SwigPyIterator", sizeof(SwigPyObject), 0,
                       Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE, slots};
...
static PyTypeObject *SwigPyBuiltin__Result_type_create(PyTypeObject *type,
   ...
   PyType_Slot slots[] = {{Py_tp_init, (void *)_wrap_new_Result},
                          ...
                          {Py_tp_members, members},
                          {0, NULL}};
   PyType_Spec spec = {"netsnmp.Result", sizeof(SwigPyObject), 0,
                       Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE, slots};
   PyObject *tuple_bases = SwigPyBuiltin_InitBases(bases);
   PyTypeObject *pytype = (PyTypeObject *)PyType_FromSpecWithBases(&spec, tuple_bases);
   PyDict_Merge(pytype->tp_dict, dict, 1);
...
static PyTypeObject *SwigPyBuiltin__std__vectorT_std__string_t_type_create(PyTypeObject *type,
   ...
   PyType_Slot slots[] = {
       ...
       {Py_tp_members, members},
       {0, NULL}};
   PyType_Spec spec = {"netsnmp._string_list", sizeof(SwigPyObject), 0,
                       Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE, slots};
   PyObject *tuple_bases = SwigPyBuiltin_InitBases(bases);
   PyTypeObject *pytype = (PyTypeObject *)PyType_FromSpecWithBases(&spec, tuple_bases);
   PyDict_Merge(pytype->tp_dict, dict, 1);
...
static PyTypeObject *SwigPyBuiltin__std__vectorT_Result_t_type_create(PyTypeObject *type,
   ...
   PyType_Slot slots[] = {
       ...
       {Py_tp_members, members},
       {0, NULL}};
   PyType_Spec spec = {"netsnmp._result_list", sizeof(SwigPyObject), 0,
                       Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE, slots};
   PyObject *tuple_bases = SwigPyBuiltin_InitBases(bases);
   PyTypeObject *pytype = (PyTypeObject *)PyType_FromSpecWithBases(&spec, tuple_bases);
   PyDict_Merge(pytype->tp_dict, dict, 1);
