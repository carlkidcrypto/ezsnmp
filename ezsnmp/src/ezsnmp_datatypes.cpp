...
#define SWIGTYPE_p_std__variantT_int_uint32_t_uint64_t_double_std__string_t swig_types[4]
...
static PyTypeObject *SwigPyBuiltin__BaseResult_type_create(PyTypeObject *type,
   ...
   PyType_Slot slots[] = {
       ...
       {0, NULL}};
   PyType_Spec spec = {"datatypes.BaseResult", sizeof(SwigPyObject), 0,
                       Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE, slots};
...
static swig_type_info _swigt__p_BaseResult = {
    "_p_BaseResult", "BaseResult *", 0, 0, (void *)&SwigPyBuiltin__BaseResult_clientdata, 0};
