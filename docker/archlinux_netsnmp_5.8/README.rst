...
Building the Image
------------------
To build the Docker image, navigate to the `docker/archlinux_netsnmp_5.8` directory and run the following command:
...
.. code-block:: bash
    ...
    docker run -it --rm archlinux_netsnmp_5.8_snmp_container /bin/bash
...
Directory Structure
===================
The `docker/archlinux_netsnmp_5.8` folder contains the following files:
