...
CONTAINER_NAME="rockylinux9_snmp_container"
...
for i in $(seq $WAIT_TIME -1 1); do
    if docker logs rockylinux9_snmp_container 2>&1 | grep -q "Starting SNMP daemon..."; then
...
docker logs rockylinux9_snmp_container --details --tail 5
