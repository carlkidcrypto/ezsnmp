...
* **almalinux10** - AlmaLinux 10 Kitten (preview) with Python 3.10-3.13, g++ 14.x (3.10-3.11 from source)
* **archlinux** - Arch Linux (latest) with Python 3.10-3.13, g++ 14.x (3.10-3.12 from source)
* **archlinux_netsnmp_5.8** - Arch Linux with net-snmp 5.8 for compatibility testing, g++ 14.x (3.10-3.12 from source)
* **centos7** - CentOS 7 with devtoolset-11 (g++ 11.2.1), Python 3.10-3.13 all from source (OpenSSL 1.1.1w built to enable SSL)
* **rockylinux8** - Rocky Linux 8 with gcc-toolset-11 (g++ 11.3.1), Python 3.10-3.13 (3.10-3.13 from source)

All images support:

* **g++ 9.5 or higher** for C++ compilation
* **Python 3.10, 3.11, 3.12, 3.13** (source builds provided where distro lacks versions)
