...
CONTAINER_NAME="fedora41_snmp_container"
...
for i in $(seq $WAIT_TIME -1 1); do
    if docker logs fedora41_snmp_container 2>&1 | grep -q "Starting SNMP daemon..."; then
...
docker logs fedora41_snmp_container --details --tail 5
