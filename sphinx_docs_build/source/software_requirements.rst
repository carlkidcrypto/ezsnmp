...
Windows (AMD64) via pre-built binary wheels distributed on PyPI.

[WHEELS-02] Windows wheels shall bundle all required Net-SNMP and OpenSSL DLLs so that no separate
Net-SNMP installation is required.
